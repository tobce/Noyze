...
public final class OpenSLESConstants {
    ...
    /**
     * Minimum volume_3 level in millibel (mb).
     */
    ...
    /**
     * The minimum volume_3 effect level in millibel (mb).
     */
    public static final short VOLUME_MIN_LEVEL = SL_MILLIBEL_MIN;
    /**
     * The minimum volume_3 stereo position in o/oo.
     */
    public static final short VOLUME_MIN_STEREO_POSITION = -1000;
    /**
     * The maximum volume_3 stereo position in o/oo.
     */
