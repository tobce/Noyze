...
public class FLog {
	 ...
	 * @see {@link #setLogLevel(FLogLevel)}
	 * @param logger
	 */
    ...
    public static boolean collectlogs(Context context, LogCollecting collecting) {
        if (null == flogger) {
            collecting.onEmptyLogCollected();
            return false;
        }
        flogger.collectlogs(context, collecting);
        return true;
    }
